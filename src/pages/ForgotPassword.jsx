    ...
    try {
      ...
      if (contentType && contentType.includes('application/json')) {
        ...
        if (response.status === 404) {
          throw new Error('Serviço de recuperação de senha não encontrado. O backend ainda não está disponível.');
      ...
      if (!response.ok) {
        throw new Error(data.message || data.error || 'Erro ao enviar email de recuperação');
      }
      ...
      let errorMessage = err.message || 'Erro ao enviar email de recuperação. Tente novamente.';
